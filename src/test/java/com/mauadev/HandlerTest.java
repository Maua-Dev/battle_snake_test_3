...
public class HandlerTest {
    ...
    public void testHandleMove_withBoardData_shouldMoveUpTowardsFood() {
        ...
        // A lógica da sua cobra deve decidir se mover para "up" para pegar a comida em (5,5)
        assertEquals("down", body.get("move"), "O movimento esperado era 'up' em direção à comida");
    }
